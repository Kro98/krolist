...
const translations = {
  ...
  ar: {
    ...
    // Auth Modal
    'auth.welcomeTo': 'أهلاً فيك في كروليست',
    'auth.collectionOfCool': 'مجموعة منتجات حلوة ومميزة',
    'auth.signIn': 'دخول',
    'auth.signUp': 'تسجيل جديد',
    'auth.email': 'الإيميل',
    'auth.password': 'كلمة السر',
    'auth.username': 'اسم المستخدم',
    'auth.enterEmail': 'اكتب إيميلك',
    'auth.enterPassword': 'اكتب كلمة السر',
    'auth.enterUsername': 'اختر اسم مستخدم',
    'auth.rememberMe': 'خليني مسجل',
    'auth.pleaseWait': 'لحظة...',
    'auth.createAccount': 'سجّل حساب جديد',
    'auth.accountCreated': 'تم إنشاء حسابك! راجع إيميلك للتأكيد.',
    'auth.welcomeBack': 'أهلاً! رجعت لنا',
    'auth.invalidEmail': 'الإيميل مو صحيح',
    'auth.usernameMin': 'اسم المستخدم لازم يكون 3 حروف على الأقل',
    'auth.passwordMin': 'كلمة السر لازم تكون 6 حروف على الأقل',
    'auth.userNotFound': 'ما لقينا حساب بهذا الإيميل',
    
    // PWA Install
    'pwa.installApp': 'حمّل التطبيق',
    'pwa.installKrolist': 'حمّل كروليست!',
    'pwa.installDescription': 'احصل على إشعارات فورية وتجربة أسرع وأسهل. مجاني!',
    'pwa.install': 'تحميل',
    'pwa.later': 'بعدين',
    'pwa.howToInstall': 'طريقة التحميل',
    'pwa.gotIt': 'تمام!',
    'pwa.usersInstalled': 'شخص حمّلوا التطبيق',
    'pwa.installSteps': 'خطوات التحميل',
    'pwa.step': 'خطوة',
    'pwa.of': 'من',
    
    // Image Cropper
    'promo.cropImage': 'قص الصورة',
    'promo.applyCrop': 'تطبيق',
    'processing': 'جاري التحميل...',
    
    // Notifications
    'notifications.title': 'الإشعارات',
    'notifications.noNotifications': 'ما في إشعارات',
    'notifications.notification': 'إشعار',
    'notifications.notifications': 'إشعارات',
    'notifications.clear': 'مسح الكل',
    'notifications.allCaughtUp': 'تمام! ما فاتك شي',
    'notifications.priceDropsWillAppear': 'بنبلّغك أول ما تنزل أسعار أو تجي عروض جديدة',
    ...
    'donation.subtitle': 'ساعدنا نخلي كروليست مجاني وبدون إعلانات مزعجة',
    
    // Events
    'events.title': 'المناسبات والعروض',
    'events.noEvents': 'ما في مناسبات قادمة حالياً',
    
    // Search
    'search.title': 'ابحث عن المنتجات',
    'search.searching': 'جاري البحث...',
    'search.noResults': 'ما لقينا شي',
    'search.tryDifferent': 'جرب كلمات ثانية',
    
    // My Orders
    'orders.title': 'طلباتي',
    'orders.noOrders': 'ما عندك طلبات بعد',
    ...
    'orders.shipped': 'في الطريق',
    'orders.delivered': 'وصل',
