...
const DEPENDENCIES: ServiceDependency[] = [
  {
    ...
    migrationSteps: [
      'Your Supabase project is already yours — no migration needed.',
      'To move to a new Supabase project: export your database schema and data from the current project.',
      'Update src/config/supabase.ts with the new SUPABASE_URL and SUPABASE_PUBLISHABLE_KEY.',
      'Update src/integrations/supabase/client.ts with the same values.',
      'Re-deploy all edge functions to the new project.',
      'No other files need changes — all URLs are centralized in src/config/supabase.ts.',
    ],
