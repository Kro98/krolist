...
const milestones = [
  { target: 10, label: "First 10 Coffees", icon: Coffee, achieved: true },
  { target: 50, label: "Server Costs Covered", icon: Target, achieved: false },
  { target: 100, label: "New Feature Fund", icon: Sparkles, achieved: false },
  { target: 250, label: "Mobile App Development", icon: Trophy, achieved: false },
];

const recentSupporters = [
  { name: "Anonymous", amount: "☕", date: "Dec 2024" },
  { name: "Ahmed K.", amount: "☕☕", date: "Dec 2024" },
  { name: "Sarah M.", amount: "☕", date: "Nov 2024" },
  { name: "Anonymous", amount: "☕☕☕", date: "Nov 2024" },
  { name: "Khalid A.", amount: "☕", date: "Oct 2024" },
];
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 py-16 text-center space-y-8">
          ...
          <Button 
            ...
            size="lg"
            className="gap-2 text-lg px-8 py-6 bg-[#FF5E5B] hover:bg-[#FF5E5B]/90 shadow-lg shadow-[#FF5E5B]/25 transition-all hover:scale-105"
          >
        ...
        <div className="text-center py-8 space-y-4">
          ...
          <div className="flex items-center justify-center gap-1">
            {[...Array(5)].map((_, i) => (
              <Sparkles 
                key={i} 
                className="h-4 w-4 text-primary/60 animate-pulse" 
