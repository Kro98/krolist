        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <Button variant="ghost" size="sm" onClick={() => setSelectedShopForCampaigns(null)}>
              ...
              <div>
                ...
                <CardDescription>
                  Manage promotional links for {selectedShopForCampaigns.name}
                </CardDescription>
              </div>
            </div>
                          ...
                          >
                            ...
                            <div className="flex items-center gap-2">
                              <Switch
                                ...
                                onCheckedChange={() => handleToggleCampaignActive(campaign)}
                              />
                              <Button
                                variant="ghost"
                                size="sm"
      ...
      <CardContent className="space-y-6 px-0">
        ...
        <DragDropContext onDragEnd={handleDragEnd}>
          <Droppable droppableId="shops">
            {provided => (
              <div {...provided.droppableProps} ref={provided.innerRef} className="space-y-2 w-full px-6">
