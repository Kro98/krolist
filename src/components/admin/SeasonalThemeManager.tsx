...
export default function SeasonalThemeManager() {
  ...
  const themes: Array<{
  ...
  }> = [
    {
      ...
      description: 'Clean interface without seasonal effects',
      descriptionAr: 'واجهة نظيفة بدون تأثيرات موسمية',
      icon: <X className="h-6 w-6 text-muted-foreground" />,
      gradient: 'bg-gradient-to-br from-muted/20 to-background',
    },
    {
      key: 'ramadan',
      title: 'Ramadan',
      titleAr: 'رمضان',
      description: 'Subtle warm amber ambient glow',
      descriptionAr: 'توهج دافئ وهادئ بالعنبر',
      icon: <Moon className="h-6 w-6 text-amber-400/80" />,
      gradient: 'bg-gradient-to-br from-amber-500/8 to-background',
    },
    {
      key: 'eid',
      title: 'Eid',
      titleAr: 'العيد',
      description: 'Soft rose champagne celebration',
      descriptionAr: 'احتفال وردي ناعم',
      icon: <PartyPopper className="h-6 w-6 text-rose-400/80" />,
      gradient: 'bg-gradient-to-br from-rose-500/8 to-background',
    },
  ];
